 ...
 * @author malek
 */
public class AuthentificationController_1 implements Initializable {
    ...
    // do what you have to do
            ...
            window.setScene(scene);  
             window.show();
                      ...
                      Logger.getLogger(AuthentificationController_1.class.getName()).log(Level.SEVERE, null, ex);
                  }
